 ...
 */
public class ThemeCoordinatorLayout extends CoordinatorLayout implements ThemeUIInterface {
    ...
    public ThemeCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ThemeCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
